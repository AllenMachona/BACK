    ...
    def ensure_default_roles(cls):
        ...
        defaults = [
            ...
            dict(code='accounting_officer', name='Accounting Officer',
              ...
              dict(code='finance_planning', name='Finance / Planning',
                  description='Certifies budgets and funds, confirms future-year provisions and financial codes, monitors commitments and payments, and performs procurement budget analysis.',
                  can_approve_procurement=True, can_view_all_records=True),
            dict(code='procurement_oversight', name='Procurement Oversight',
                 can_approve_procurement=True, can_view_all_records=True),
            dict(code='pou', name='Procurement Oversight Unit',
                 description='Read-only oversight unit to vet tender and evaluation submissions without changing records.',
                 can_view_all_records=True),
              dict(code='procurement_unit', name='Procurement Unit',
                  can_create_procurement=True, can_publish=True, can_award=True,
                  can_view_all_records=True),
